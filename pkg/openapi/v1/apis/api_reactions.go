...
/*
CastLikes Get all like reactions for a specific cast
...
func (a *ReactionsAPIService) CastLikesExecute(r ApiCastLikesRequest) (*CastLikesResponse, *http.Response, error) {
	...
	if r.castHash == nil {
		return localVarReturnValue, nil, reportError("castHash is required and must be specified")
	}

	parameterAddToHeaderOrQuery(localVarQueryParams, "castHash", r.castHash, "")
	if r.viewerFid != nil {
...
/*
CastReactions Get all reactions for a specific cast
...
/*
CastRecasters Get all recasters for a specific cast
