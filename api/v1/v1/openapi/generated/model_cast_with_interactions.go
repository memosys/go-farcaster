...
type CastWithInteractions struct {
	...
	Reactions CastWithInteractionsReactionsOrRecasts `json:"reactions"`
	Recasts CastWithInteractionsReactionsOrRecasts `json:"recasts"`
...
func (o *CastWithInteractions) GetReactions() CastWithInteractionsReactionsOrRecasts {
	if o == nil {
		var ret CastWithInteractionsReactionsOrRecasts
		return ret
	}
...
func (o *CastWithInteractions) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCastWithInteractions)
