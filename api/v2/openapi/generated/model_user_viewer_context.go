...
// UserViewerContext struct for UserViewerContext
...
func (o *UserViewerContext) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varUserViewerContext)
